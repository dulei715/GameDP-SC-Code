...
import edu.ecnu.dll.basic.basic_struct.comparator.WorkerIDDistancePairComparator;
...
public class NonPrivacyDistanceConflictElimination {
...
//    public SimplePreferenceTable simplePreferenceTable = null;
    public PreferenceTable<WorkerIDDistancePair, WorkerIDDistancePairComparator> preferenceTable = null;
    ...
    public NonPrivacyDistanceConflictElimination(Integer taskSize, Integer workerSize) {
        this.taskSize = taskSize;
        this.workerSize = workerSize;
        this.workerIDDistancePairComparator = new WorkerIDDistancePairComparator();
    }

    public NonPrivacyDistanceConflictElimination(Integer taskSize, Integer workerSize, WorkerIDDistancePairComparator workerIDDistancePairComparator) {
        this.taskSize = taskSize;
        this.workerSize = workerSize;
...
//        this.taskPreferenceListArray = new int[this.tasks.length][this.workers.length];
        ...
        this.preferenceTable = new PreferenceTable(this.taskSize, this.workerIDDistancePairComparator);
...
//        this.conflictWorkerIDList = new LinkedList<>();
        ...
        for (int i = 0; i < this.taskSize; i++) {
            if (this.taskPreferenceIndex[i] >= this.preferenceTable.table[i].size()) {
                result[i] = NonPrivacyDistanceConflictElimination.DEFAULT_WORKER_ID_DISTANCE_PAIR.getWorkerID();
            } else {
    ...
    public WorkerIDDistancePair[] assignment(List<WorkerIDDistancePair>[] newCandidateWorkerIDList) {
        ...
        for (int i = 0; i < this.taskSize; i++) {
            if (this.taskPreferenceIndex[i] >= this.preferenceTable.table[i].size()) {
                result[i] = NonPrivacyDistanceConflictElimination.DEFAULT_WORKER_ID_DISTANCE_PAIR;
            } else {
