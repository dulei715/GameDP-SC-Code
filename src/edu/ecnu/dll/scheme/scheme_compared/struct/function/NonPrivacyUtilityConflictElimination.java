package edu.ecnu.dll.scheme.scheme_compared.struct.function;


import edu.ecnu.dll.basic.basic_struct.comparator.WorkerIDNoDistanceUtilityDistancePairComparator;
...
public class NonPrivacyUtilityConflictElimination {

    public static final WorkerIDNoDistanceUtilityDistancePair DEFAULT_WORKER_ID_NO_DISTANCE_UTILITY_DISTANCE_PAIR = new WorkerIDNoDistanceUtilityDistancePair(-1, Double.MAX_VALUE, 0.0);
...
//    public SimplePreferenceTable simplePreferenceTable = null;
    public PreferenceTable<WorkerIDNoDistanceUtilityDistancePair, WorkerIDNoDistanceUtilityDistancePairComparator> preferenceTable = null;
    ...
    public WorkerIDNoDistanceUtilityDistancePairComparator workerIDNoDistanceUtilityDistancePairComparator;


    public NonPrivacyUtilityConflictElimination(Integer taskSize, Integer workerSize) {
        this.taskSize = taskSize;
        this.workerSize = workerSize;
        this.workerIDNoDistanceUtilityDistancePairComparator = new WorkerIDNoDistanceUtilityDistancePairComparator();
    }

    public NonPrivacyUtilityConflictElimination(Integer taskSize, Integer workerSize, WorkerIDNoDistanceUtilityDistancePairComparator workerIDNoDistanceUtilityDistancePairComparator) {
        this.taskSize = taskSize;
        this.workerSize = workerSize;
        this.workerIDNoDistanceUtilityDistancePairComparator = workerIDNoDistanceUtilityDistancePairComparator;
    }
     ...
     */
    public void initialize(List<WorkerIDNoDistanceUtilityDistancePair>[] data) {
//        this.taskPreferenceListArray = new int[this.tasks.length][this.workers.length];
        ...
        this.preferenceTable = new PreferenceTable(this.taskSize, this.workerIDNoDistanceUtilityDistancePairComparator);
     ...
     * @return
     */
    protected WorkerIDNoDistanceUtilityDistancePair getNextWorkerInfo(Integer taskID) {
    ...
    protected WorkerIDNoDistanceUtilityDistancePair getCurrentWorkerInfo(Integer taskID) {
    ...
    protected void solveConflict(Integer workerID) {
        WorkerIDNoDistanceUtilityDistancePair chosenTaskNextWorkerInfo, tempTaskNextWorkerInfo, chosenTaskCurrentWorkerInfo, tempTaskCurrentWorkerInfo;
...
//                if (compareFourValuesWithSuccessor(workerID, chosenTaskID, tempTaskID, chosenTaskNextWorkerInfo, tempTaskNextWorkerInfo)) {
     ...
     */
    protected boolean compareFourValuesWithSuccessor(WorkerIDNoDistanceUtilityDistancePair taskIDAWorkerInfo, WorkerIDNoDistanceUtilityDistancePair taskIDBWorkerInfo, WorkerIDNoDistanceUtilityDistancePair taskIDANextWorkerInfo, WorkerIDNoDistanceUtilityDistancePair taskIDBNextWorkerInfo) {
        double tempPCFValue;
        tempPCFValue = taskIDBWorkerInfo.getUtility() + taskIDANextWorkerInfo.getUtility() - taskIDAWorkerInfo.getUtility() - taskIDBNextWorkerInfo.getUtility();
     ...
     */
    protected boolean compareWithCurrentInfo(WorkerIDNoDistanceUtilityDistancePair taskIDAWorkerInfo, WorkerIDNoDistanceUtilityDistancePair taskIDBWorkerInfo) {
        double tempPCFValue;
        tempPCFValue = taskIDBWorkerInfo.getUtility() - taskIDAWorkerInfo.getUtility();
        if (tempPCFValue > 0) {
            return true;
        }
        return false;
...
//        this.conflictWorkerIDList = new LinkedList<>();
        ...
        for (int i = 0; i < this.taskSize; i++) {
            if (this.taskPreferenceIndex[i] >= this.preferenceTable.table[i].size()) {
                result[i] = NonPrivacyUtilityConflictElimination.DEFAULT_WORKER_ID_NO_DISTANCE_UTILITY_DISTANCE_PAIR.getWorkerID();
            } else {
    ...
    public WorkerIDNoDistanceUtilityDistancePair[] assignment(List<WorkerIDNoDistanceUtilityDistancePair>[] newCandidateWorkerIDList) {
        WorkerIDNoDistanceUtilityDistancePair[] result = new WorkerIDNoDistanceUtilityDistancePair[this.taskSize];
        ...
        for (int i = 0; i < this.preferenceTable.taskSize; i++) {
            ...
            workerID = this.preferenceTable.table[i].get(0).getWorkerID();
            if (workerID.equals(DEFAULT_WORKER_ID_NO_DISTANCE_UTILITY_DISTANCE_PAIR.getWorkerID())) {
                continue;
            }
        ...
        for (int i = 0; i < this.taskSize; i++) {
            if (this.taskPreferenceIndex[i] >= this.preferenceTable.table[i].size()) {
                result[i] = NonPrivacyUtilityConflictElimination.DEFAULT_WORKER_ID_NO_DISTANCE_UTILITY_DISTANCE_PAIR;
            } else {
    ...
    public void assignment(List<WorkerIDNoDistanceUtilityDistancePair>[] newCandidateWorkerIDList, Integer[] winnerArray) {
