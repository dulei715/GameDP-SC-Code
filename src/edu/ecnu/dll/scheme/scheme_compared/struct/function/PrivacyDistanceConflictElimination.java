...
public class PrivacyDistanceConflictElimination {
...
//    public int[][] taskPreferenceListArray = null;
    public PreferenceTable<WorkerIDNoiseDistanceBudgetPair, WorkerIDNoiseDistanceBudgetPairComparator> preferenceTable = null;
    ...
    public WorkerIDNoiseDistanceBudgetPairComparator workerIDNoiseDistanceBudgetPairComparator;


    public PrivacyDistanceConflictElimination(Integer taskSize, Integer workerSize) {
        this.taskSize = taskSize;
        this.workerSize = workerSize;
        this.workerIDNoiseDistanceBudgetPairComparator = new WorkerIDNoiseDistanceBudgetPairComparator();
    }

    public PrivacyDistanceConflictElimination(Integer taskSize, Integer workerSize, WorkerIDNoiseDistanceBudgetPairComparator workerIDNoiseDistanceBudgetPairComparator) {
        this.taskSize = taskSize;
        this.workerSize = workerSize;
        this.workerIDNoiseDistanceBudgetPairComparator = workerIDNoiseDistanceBudgetPairComparator;
    }
...
//        this.taskPreferenceListArray = new int[this.tasks.length][this.workers.length];
        ...
        this.preferenceTable = new PreferenceTable(this.taskSize, this.workerIDNoiseDistanceBudgetPairComparator);
