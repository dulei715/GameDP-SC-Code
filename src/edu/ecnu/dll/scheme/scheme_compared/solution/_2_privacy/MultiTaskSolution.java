package edu.ecnu.dll.scheme.scheme_compared.solution._2_privacy;
...
//                this.workers[j].getToTaskDistance(i) = BasicCalculation.get2Norm(this.workers[j].location, this.tasks[i].location);
