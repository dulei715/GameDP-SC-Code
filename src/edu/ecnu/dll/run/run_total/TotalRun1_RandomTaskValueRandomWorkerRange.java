...
public class TotalRun1_RandomTaskValueRandomWorkerRange {
...
//        String datasetName = "ChengduDiDi";
        ...
        String workerRangeFileName = Constant.FILE_PATH_SPLIT + "worker_range.txt";
        ...
        String outputPath = basicPath + Constant.FILE_PATH_SPLIT + "outputPath" + Constant.FILE_PATH_SPLIT + "output_value_range_random.csv";
...
//        GreedyNonePrivacySolution greedyNPSolution = new GreedyNonePrivacySolution();
        ...
        // 读入生成数据
        List<Double> taskValueList = DoubleRead.readDoubleWithFirstSizeLineToList(basicPath + parentPartPath + taskValueFileName);
        List<Double> workerRangeList = DoubleRead.readDoubleWithFirstSizeLineToList(basicPath + parentPartPath + workerRangeFileName);
...
//        System.out.println(title);
        ...
        ppfState = false;
        ExtendedExperimentResult uConflictPrivacyNoPPCF = ConflictEliminationCompleteRun.runningOnSingleDatasetWithUtilityConflictElimination(taskPointList, workerPointList, workerPrivacyBudgetList, workerNoiseDistanceList, ppfState, taskValueList, workerRangeList, proposalSize, dataType);
...
//            System.out.println(uConflictPrivacyNoPPCFResult.toString());
        ...
        ppfState = true;
        ExtendedExperimentResult uConflictPrivacyPPCF = ConflictEliminationCompleteRun.runningOnSingleDatasetWithUtilityConflictElimination(taskPointList, workerPointList, workerPrivacyBudgetList, workerNoiseDistanceList, ppfState, taskValueList, workerRangeList, proposalSize, dataType);
...
//            System.out.println(uConflictPrivacyPPCFResult);
        ...
        ppfState = false;
        ExtendedExperimentResult dConflictPrivacyNoPPCF = ConflictEliminationCompleteRun.runningOnSingleDatasetWithDistanceConflictElimination(taskPointList, workerPointList, workerPrivacyBudgetList, workerNoiseDistanceList, ppfState, taskValueList, workerRangeList, proposalSize, dataType);
...
//            System.out.println(dConflictPrivacyNoPPCResult);
        ...
        ppfState = true;
        ExtendedExperimentResult dConflictPrivacyPPCF = ConflictEliminationCompleteRun.runningOnSingleDatasetWithDistanceConflictElimination(taskPointList, workerPointList, workerPrivacyBudgetList, workerNoiseDistanceList, ppfState, taskValueList, workerRangeList, proposalSize, dataType);
...
//            System.out.println(dConflictPrivacyPPCResult);
        ...
        ExtendedExperimentResult gPrivacy = GameIterationCompleteRun.runningOnSingleDataset(taskPointList, workerPointList, workerPrivacyBudgetList, workerNoiseDistanceList, taskValueList, workerRangeList, dataType);
...
//            System.out.println(gPrivacyResult);
        ...
        ExtendedExperimentResult uConflictNonPrivacy = ConflictEliminationNonPrivacyCompleteRun.runningOnSingleDatasetWithUtilityConflictElimination(taskPointList, workerPointList, taskValueList, workerRangeList, proposalSize, dataType);
...
//            System.out.println(uConflictNonPrivacyResult);
        ...
        ExtendedExperimentResult dConflictNonPrivacy = ConflictEliminationNonPrivacyCompleteRun.runningOnSingleDatasetWithDistanceConflictElimination(taskPointList, workerPointList, taskValueList, workerRangeList, proposalSize, dataType);
...
//            System.out.println(dConflictNonPrivacyResult);
        ...
        ExtendedExperimentResult gNonPrivacy = GameIterationNonPrivacyCompleteRun.runningOnSingleDataset(taskPointList, workerPointList, taskValueList, workerRangeList, dataType);
...
//            System.out.println(gNonPrivacyResult);
        ...
        ExtendedExperimentResult greedyNonPrivacy = GreedyNonPrivacyCompleteRun.runningOnSingleDataset(taskPointList, workerPointList, taskValueList, workerRangeList, dataType);
