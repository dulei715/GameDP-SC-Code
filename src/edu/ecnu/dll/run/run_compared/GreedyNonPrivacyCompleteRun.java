...
public class GreedyNonPrivacyCompleteRun extends AbstractRun {
...
//        System.out.println(normalExperimentResult);
    ...
    public static ExtendedExperimentResult runningOnSingleDataset(List<Point> taskPointList, List<Point> workerPointList,
        ...
        greedyNPSolution.initializeBasicInformation(taskPointList, taskValue, workerPointList, workerRange);
