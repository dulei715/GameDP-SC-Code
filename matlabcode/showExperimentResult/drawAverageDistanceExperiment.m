function y = drawAverageDistanceExperiment(filename, xCol, yCol, xLabelName, yLabelName, outputFileName, figure_MarkerSize, figure_FontSize_X, figure_FontSize_Y, figure_FontSize)
