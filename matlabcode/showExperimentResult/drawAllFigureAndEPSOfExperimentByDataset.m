function y = drawAllFigureAndEPSOfExperimentByDataset(input_parent_path, output_parent_path, output_dataset_name)
%% 画关于运行时间的图
...
drawTimeCostExperiment(dataFilePath, workerRatioLine, xName, yName, outputFileName);
...
drawAverageUtilityExperiment(dataFilePath, taskValueLine,UtilityLine, xName, yName, outputFileName);
...
drawRelativeDeviationUtilityExperiment(dataFilePath, taskValueLine,UtilityLine, xName, yName, outputFileName);
...
xName = 'worker range';
yName = 'average utility';
drawAverageUtilityExperiment(dataFilePath, workerRangeLine,UtilityLine, xName, yName, outputFileName);
...
xName = 'worker range';
yName = 'relative deviation of utility';
drawRelativeDeviationUtilityExperiment(dataFilePath, workerRangeLine,UtilityLine, xName, yName, outputFileName);
...
xName = 'worker ratio';
yName = 'average utility';
drawAverageUtilityExperiment(dataFilePath, workerRatioLine, UtilityLine, xName, yName, outputFileName);
...
xName = 'worker ratio';
yName = 'relative deviation of utility';
drawRelativeDeviationUtilityExperiment(dataFilePath, workerRatioLine,UtilityLine, xName, yName, outputFileName);
...
drawAverageDistanceExperiment(dataFilePath, taskValueLine,DistanceLine, xName, yName, outputFileName);
...
drawRelativeDeviationDistanceExperiment(dataFilePath, taskValueLine,DistanceLine, xName, yName, outputFileName);
...
xName = 'worker range';
yName = 'average distance (km)';
drawAverageDistanceExperiment(dataFilePath, workerRangeLine,DistanceLine, xName, yName, outputFileName);
...
xName = 'worker range';
yName = 'relative deviation of distance';
drawRelativeDeviationDistanceExperiment(dataFilePath, workerRangeLine,DistanceLine, xName, yName, outputFileName);
...
xName = 'worker ratio';
yName = 'average distance (km)';
drawAverageDistanceExperiment(dataFilePath, workerRatioLine, DistanceLine, xName, yName, outputFileName);
...
xName = 'worker ratio';
yName = 'relative deviation of distance';
drawRelativeDeviationDistanceExperiment(dataFilePath, workerRatioLine,DistanceLine, xName, yName, outputFileName);
