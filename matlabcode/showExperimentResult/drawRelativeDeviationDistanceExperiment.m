function y = drawRelativeDeviationDistanceExperiment(filename, xCol, yCol, xLabelName, yLabelName,outputFileName, figure_MarkerSize, figure_FontSize_X, figure_FontSize_Y, figure_FontSize)
...
ucps_pf = (uConfPSolution_ppcfFalse - uConfNPSolution) ./ uConfNPSolution;
ucps_pt = (uConfPSolution_ppcfTrue - uConfNPSolution) ./ uConfNPSolution;
dcps_pf = (dConfPSolution_ppcfFalse - dConfNPSolution) ./ dConfNPSolution;
dcps_pt = (dConfPSolution_ppcfTrue - dConfNPSolution) ./ dConfNPSolution;
gps_pf = (gPSolution - gNPSolution) ./ gNPSolution;
