function y = drawAllFigureAndPDFOfExperiment(outputBasicParentPath)
...
"E:\1.学习\1.学校\1.华师大\1.课程\transmit\writing_paper\paper1_CSGT\experimentResult\2022.10\experiment2\1.chengdu\outputPath_average\",
...
"E:\1.学习\1.学校\1.华师大\1.课程\transmit\writing_paper\paper1_CSGT\experimentResult\2022.10\experiment2\3.uniform\outputPath_average\",
...
"E:\1.学习\1.学校\1.华师大\1.课程\transmit\writing_paper\paper1_CSGT\experimentResult\2022.10\experiment2\2.normal\outputPath_average\"
];
...
for i = 1:length(inputParentArray)
    %disp(i);
    drawAllFigureAndPDFOfExperimentByDataset(char(inputParentArray(i)),char(outputParentArray(i)),char(inputFileNameArray(i)));
end
